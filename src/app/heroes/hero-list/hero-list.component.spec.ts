...
describe('HeroListComponent', () => {
    ...
    describe('onDelete', () => {
        ...
        it('should wrap the delete call with loadingService.withLoading', () => {
            component.onDelete(1, 'SUPERMAN');
            afterClosed$.next(true);
            expect(loadingServiceStub.withLoading).toHaveBeenCalled();
        });
